...
<template>
  <div class="Page">
    ...
    <button class="muteButton" @click="handleMute">
      <span v-if="muted" v-html="speakerOff" />
      <span v-else v-html="speakerLoud" />
    </button>
  </div>
</template>
